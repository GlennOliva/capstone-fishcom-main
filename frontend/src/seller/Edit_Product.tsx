  ...
  <Link to="/seller_profile">
    ...
    <form action="your_action_url" method="POST" encType="multipart/form-data">
        <div className="image-section">
            <div className="image-placeholder"></div> {/* Placeholder for the image */}
            <label htmlFor="current-image">Current Image:</label> {/* Centered label */}
        </div>
        
        <div className="form-row">
            <div className="form-group">
                <label htmlFor="product_name">Product Name</label>
                <input type="text" id="product_name" name="product_name" placeholder="Enter Product Name" className="input-field" />
            </div>
            <div className="form-group">
                <label htmlFor="product_description">Product Description</label>
                <input type="text" id="product_description" name="product_description" placeholder="Enter Product Description" className="input-field" />
            </div>
        </div>
        ...
        <div className="form-row">
            ...
            <div className="form-group">
                ...
                <input type="file" id="image" name="image" accept="image/*" className="input-file" />
            </div>
        </div>
